...
class DAQdata(object):
    ...
    def Plot(self, Sensor_Name1, Sensor_Name2, Figure_Number,  ScaleX= 1, OffsetX = 0, ScaleY= 1, OffsetY = 0, Color = 'k', Reading_Rate = 5000000, Title=None ):
...
#             ax.tick_params(axis='x',which='minor',bottom='off')
    ...
    ###################################################################################################
    def Extract(self,User_Start_Time, User_End_Time,Reading_Rate=100000):
